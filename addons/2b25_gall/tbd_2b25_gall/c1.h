/*
    ...
    CONFIG PATH: bin\config.bin/CfgVehicles/tbd_2b25_gall
    SOURCE ADD-ON(S): tbd_2b25_gall
*/
...
class tbd_2b25_gall {
    ...
    model = "\x\TBD\addons\2b25_gall\tbd_2b25_gall\tbd_2b25_gall";
    editorPreview = "\x\TBD\addons\2b25_gall\tbd_2b25_gall\data\preview.paa";
    side = 0;
    faction = "OPF_F";
    crew = "B_Soldier_F";
    transportSoldier = 0;
    ...
    class ACE_Actions {
        class ACE_MainActions {
            ...
            class ace_csw_getIn {
                displayName = $STR_ACE_CSW_GETIN_DISPLAYNAME;
